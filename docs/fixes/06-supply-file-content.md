...
**Status:** optional · **Read first:** [`_testing-philosophy.md`](./_testing-philosophy.md)
...
## Test cases
- [ ] single-file fix → session input contains the target file's current source
- [ ] file missing/unreadable → clean failure outcome, no crash
